...
# ── Step 2: Decision trail markdown cell ──────────────────────────────────────
md("md-decision-trail", [
    "---\n",
...
# ── Step 3: docs/model_card.md ────────────────────────────────────────────────
md("md-model-card-intro", [
    "---\n",
    "## Step 3 · Create `docs/model_card.md`\n"
]),

code("cell-model-card", [
